...
public class Conexao2 {
    private static final String LOG_TAG = Conexao2.class.getSimpleName();
    // Constantes utilizadas pela API
    // URL para a API de Livros do Google.


    static String buscarTeaminfo(String queryString) {
        ...
        try {
            ...
            URL requestURL = new URL("https://free-nba.p.rapidapi.com/teams/" + queryString);
